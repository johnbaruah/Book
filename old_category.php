...
<?php       
                ...
                if ($resultSet10) {
                    ...
                    if($cart_add_query_check_qty){
                      ...
                      if($p_quantity_check != 0){
                         ...
                         if ($cart_add_query) {
                       header("location:old_category.php");
                        }else{
            ...
            $query6 = "select * from product where cat_name = 'old' LIMIT 30";
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Old Books</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
              ...
              <div class="card sidebar-menu mb-4">
                ...
                <div class="card-body">
                  <ul class="nav nav-pills flex-column category-menu">
                    <li><a href="old_category.php" class="nav-link active">Old Books</a>
                      
                    </li>
                    <li><a href="new_category.php" class="nav-link">New Books</a>
            ...
            <div class="col-lg-9">
              <div class="box">
                <h1>Old Books</h1>
                <p>In our Old Book department we offer wide selection of the best books we have found and carefully selected worldwide.</p>
              </div>
