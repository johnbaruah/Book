                  ...
                  <tbody>
                        ...
                        while($res = mysqli_fetch_array($query7)){ 
                          ...
                          <tr class="tbl-bg align-middle">
                            ...
                            <td class="inpt"><?php if ($res['verified'] == 1) { ?>
                              <button class="btn btn-danger"><a style="color: white;" class="p-0 m-0" href="block.php?id=<?php echo $res['id']; ?>">Block</a></button>
                           <?php }elseif ($res['verified'] == 0) { ?>
                              <button class="btn btn-success"><a style="color: white;" class="p-0 m-0" href="unblock.php?id=<?php echo $res['id']; ?>">UnBlock</a></button>
                           <?php } ?></td>
